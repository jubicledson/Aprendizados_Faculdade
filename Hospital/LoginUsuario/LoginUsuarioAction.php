<?php
    ...
    $resultado = $comando->execute(array('senha' => md5($_GET['senhaUsuario']), 'idLogin' => $_GET['idLogin']));
?>
...
<?php
    if($resultado){
        ...
        if($login == true){
            ...
            header('Location: http://localhost/conteudo/Hospital/LoginUsuario/HomeUsuario.php');
        }else{
            echo "Erro ao logar";
        }
